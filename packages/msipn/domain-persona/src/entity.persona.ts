import { EntityDefinition, esAdminLike, tieneRol, registerEntity } from '@pasosdejesus/msipn-core';

export const personaEntity: EntityDefinition = {
  name: 'persona',
  table: 'msip_persona',
  primaryKey: 'id',
  ...
  presentation: { label: (r: any) => `${r.nombres} ${r.apellidos}`.trim() }
};
