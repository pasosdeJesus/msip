import { EntityDefinition, esAdminLike, registerEntity } from '@pasosdejesus/msipn-core';

export const usuarioEntity: EntityDefinition = {
  name: 'usuario',
  table: 'usuario',
  primaryKey: 'id',
  ...
  presentation: { label: (r: any) => r.nusuario }
};
