  ...
  if (typeof process.env.CI == "string") {
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_municipio_id_chosen"]/a/span'
            ],
            [
                'pierce/div.clase_municipio span'
            ],
            [
                'text/Seleccione una'
            ]
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_municipio_id_chosen"]/div/ul/li[1]'
            ],
            [
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_clalocal_cod"]'
            ],
            [
                'pierce/#clase_clalocal_cod'
            ]
        ], targetPage, timeout);
        const element = await waitForSelectors([
            [
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_latitud"]'
            ],
            [
                'pierce/#clase_latitud'
            ]
        ], targetPage, timeout);
        const element = await waitForSelectors([
            [
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_longitud"]'
            ],
            [
                'pierce/#clase_longitud'
            ]
        ], targetPage, timeout);
        const element = await waitForSelectors([
            [
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="clase_observaciones"]'
            ],
            [
                'pierce/#clase_observaciones'
            ]
        ], targetPage, timeout);
        const element = await waitForSelectors([
            [
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                'xpath///*[@id="new_clase"]/div[11]/input'
            ],
            [
