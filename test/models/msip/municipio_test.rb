...
module Msip
  class MunicipioTest < ActiveSupport::TestCase
    test "valido" do
      ...
      assert_equal "y / x", Msip::Ubicacionpre.where(departamento_id: departamento_id).take.nombre
      ...
      assert_equal "z / y / x", Msip::Ubicacionpre.where(municipio_id: municipio_id).take.nombre
      assert_equal "z / y", Msip::Ubicacionpre.where(
        municipio_id: municipio_id
      ).take.nombre_sin_pais
      ...
      assert_equal "b / y / x", Msip::Ubicacionpre.where(
        municipio_id: municipio_id
      ).take.nombre
      assert_equal "b / y", Msip::Ubicacionpre.where(
        municipio_id: municipio_id
      ).take.nombre_sin_pais
