...
module Msip
  class CentropobladoTest < ActiveSupport::TestCase
    test "valido" do
      ...
      assert_equal "c / b / a", Msip::Ubicacionpre.where(municipio_id: municipio_id).take.nombre
      assert_equal "c / b", Msip::Ubicacionpre.where(
      ...
      assert_equal "c / c / b / a", Msip::Ubicacionpre.
        where(centropoblado_id: centropoblado_id).take.nombre
      assert_equal "c / c / b", Msip::Ubicacionpre.
        where(centropoblado_id: centropoblado_id).take.nombre_sin_pais
