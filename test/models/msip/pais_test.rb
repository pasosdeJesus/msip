...
module Msip
  ...
  class PaisTest < ActiveSupport::TestCase
    test "nuevo valido" do
      ...
      assert_equal "y", Msip::Ubicacionpre.where(pais_id: pais_id).take.nombre
      assert_equal "", Msip::Ubicacionpre.where(pais_id: pais_id).take.nombre_sin_pais
      ...
      # Se debió disparar el trigger de actualización de ubicacionpre 
      assert_equal "z", Msip::Ubicacionpre.where(pais_id: pais_id).take.nombre
      assert_equal "", Msip::Ubicacionpre.
        where(pais_id: pais_id).take.nombre_sin_pais
      assert_equal "y / z", Msip::Ubicacionpre.
        where(departamento_id: departamento_id, municipio_id: nil).take.nombre
      assert_equal "y", Msip::Ubicacionpre.
