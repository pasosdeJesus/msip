  ...
  module Admin
    class DepartamentosControllerTest < ActionDispatch::IntegrationTest
      ...
      test "debe presentar listado" do
        get msip.admin_departamentos_path
      ...
      test "debe presentar resumen de existente" do
        get msip.admin_departamento_url(Departamento.find(1))
      ...
      test "debe presentar formulario para nueva" do
        get msip.new_admin_departamento_path
      ...
      test "debe crear nueva" do
        ...
        assert_difference("Departamento.count") do
          post msip.admin_departamentos_path, params: {
            departamento: TDEPARTAMENTO_NUEVO,
          }
        end

        assert_redirected_to msip.admin_departamento_path(
          assigns(:departamento),
        )
      end

      test "debe actualizar existente" do
        patch msip.admin_departamento_path(Departamento.find(1)),
      ...
      test "debe eliminar" do
        ...
        assert_difference("Departamento.count", -1) do
          delete msip.admin_departamento_url(Departamento.find(1))
        end

        assert_redirected_to msip.admin_departamentos_path
      end
    end
  end
end
