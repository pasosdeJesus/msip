  ...
  module Admin
    class TiposorgControllerTest < ActionDispatch::IntegrationTest
      ...
      test "debe presentar listado" do
        get filtra_doble_ruta_relativa(msip.admin_tiposorg_path)
      ...
      test "debe presentar resumen de existente" do
        get filtra_doble_ruta_relativa(msip.admin_tipoorg_path(Tipoorg.find(1)))
      ...
      test "debe presentar formulario para nueva" do
        get filtra_doble_ruta_relativa(msip.new_admin_tipoorg_path)
      ...
      test "debe crear nueva" do
        if Msip::Tipoorg.where(nombre: "X").count > 0
          Msip::Tipoorg.where(nombre: "X").destroy_all
        end
        assert_difference("Tipoorg.count") do
          post filtra_doble_ruta_relativa(msip.admin_tiposorg_path), params: {
      ...
      test "debe actualizar existente" do
        patch filtra_doble_ruta_relativa(msip.admin_tipoorg_path(
          Tipoorg.find(1),
        )),
      ...
      test "debe eliminar" do
        ...
        assert_difference("Tipoorg.count", -1) do
          delete filtra_doble_ruta_relativa(msip.admin_tipoorg_path(Tipoorg.find(1)))
        end

        assert_redirected_to filtra_doble_ruta_relativa(msip.admin_tiposorg_path)
      end
    end
  end
end
